...
const dict = {
  en: {
    ...
    errReauthNeeded:
      "For security, a new password has to be set from a reset email. Sign out and use “Forgot password?” to get one.",
    ...
    noExpensesForMember: "No expenses paid by this member.",
    filterByPayer: "Paid by",
    everyone: "Everyone",
    paidVerb: "paid",
    newer: "Newer",
    older: "Older",
    ...
    amountNoDecimals: "{currency} amounts are whole numbers — leave out the decimals.",
    amountTooPrecise: "{currency} amounts can have at most {n} decimal places.",
  ...
  pl: {
    ...
    errReauthNeeded:
      "Ze względów bezpieczeństwa nowe hasło można ustawić tylko z e-maila resetującego. Wyloguj się i użyj „Nie pamiętasz hasła?”, aby go otrzymać.",
    ...
    noExpensesForMember: "Brak wydatków opłaconych przez tę osobę.",
    filterByPayer: "Zapłacił(a)",
    everyone: "Wszyscy",
    paidVerb: "zapłacił(a)",
    newer: "Nowsze",
    older: "Starsze",
    ...
    amount: "Kwota",
    amountInvalid: "Podaj poprawną kwotę, na przykład 120,50.",
    amountNotPositive: "Kwota musi być większa niż 0.",
    amountNoDecimals: "Kwoty w walucie {currency} podaje się w liczbach całkowitych — bez części dziesiętnej.",
    amountTooPrecise: "Kwoty w walucie {currency} mogą mieć najwyżej {n} miejsca po przecinku.",
    amountTooLarge: "Ta kwota jest za duża.",
    currency: "Waluta",
    category: "Kategoria",
